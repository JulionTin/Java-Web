 ...
 * @author Joseph
 */
@WebServlet(name = "EditEvent", urlPatterns = {"/do.edit"})
public class EditEvent extends HttpServlet {
    ...
    if (reservationId == null || reservationId.isEmpty() || title == null || title.isEmpty() || date == null || capacity <= 0 || building == null || building.isEmpty() || floor == null || floor.isEmpty() || room == null || room.isEmpty() || time == null) {
        ...
        try {
            ...
            String updateQuery = "UPDATE reservation SET title = ?, res_date = ?, res_time = ?, capacity = ?, building_id = ?, floor_id = ?, room_id = ?, res_description = ?, acc_id = ? WHERE reservation_id = ?";
            ...
            ps1.setInt(9, acc_id);
            ps1.setInt(10, Integer.parseInt(reservationId));
